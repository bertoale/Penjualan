            ...
            <div class="grid gap-4 mb-4 grid-cols-2">
              ...
              <div class="col-span-2 sm:col-span-1">
                ...
                >
                  ...
                  <option
                    v-for="kategori in dataProdukKategori"
                    :key="kategori.id"
                    :value="kategori.id"
                  >
                    {{ kategori.nama }}
  ...
  (val) => {
    if (props.isEdit && val) {
      form.value = {
        ...
        nama: val.nama,
        kategori_id: val.kategori_id || val.ProdukKategoriId || "",
        harga_beli: Number(val.harga_beli) || 0,
        harga_jual: Number(val.harga_jual) || 0,
        stok: val.stok || 0,
      };
    } else {
      form.value = {
